...
from gitsvg.render._table._columns import TableColumn, TableColumns, TableField, compute_table_columns
from gitsvg.render._table._text import fit_text, flatten_message
