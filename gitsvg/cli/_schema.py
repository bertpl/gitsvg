...
Note `gitsvg schema theme` prints the `theme` *op*'s JSON Schema (it is one
of the ops). Inspecting the built-in named themes lives on the separate
`gitsvg theme` command.
"""
...
def _render_index() -> str:
    ...
    lines += [
        ...
        "Run `gitsvg theme` to inspect the built-in named themes.",
    ]
