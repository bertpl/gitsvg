...
def test_commit_row_band_color_resolves_through_apply() -> None:
    ...
    # --- arrange / act ----------------
    parsed, report = parse_jsonl_text('{"op": "theme", "commit_row_band_color": "#11223344"}\n', file="x.jsonl")
...
def test_commit_row_band_color_accepts_alpha_hex_forms() -> None:
    ...
    parsed, report = parse_jsonl_text(
        '{"op": "theme", "commit_row_band_color": "#1234"}\n{"op": "theme", "commit_row_band_color": "#11223344"}\n',
        file="x.jsonl",
    )
...
def test_commit_row_band_color_rejects_malformed_hex() -> None:
    ...
    # --- arrange / act ----------------
    parsed, report = parse_jsonl_text('{"op": "theme", "commit_row_band_color": "#12345"}\n', file="x.jsonl")
    apply_ops(parsed, report)
